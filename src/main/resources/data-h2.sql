INSERT INTO USERS VALUES('user1','{bcrypt}$2a$10$Yez9dfvkoDAjcLKslH6LCedWWXAl8PIVZtnU73ZT3H0Tu7xR0Cpy6',TRUE);
INSERT INTO USERS VALUES('user2','{bcrypt}$2a$10$.TRNKvrM.IPJMwiHy4.nheoLo1o8BStddmeyj8bFRG6MKYU4fITbO',TRUE);
INSERT INTO USERS VALUES('user3','{bcrypt}$2a$10$tJBLS/6eJjvjqsa.968dxOBPJ5p1SOh2LXzoxqtrOJ76RhbRoUPvG',TRUE);

INSERT INTO AUTHORITIES VALUES('user1','ROLE_XXX');
